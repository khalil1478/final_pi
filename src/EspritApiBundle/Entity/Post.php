 ...
 *
 * @ORM\Table(name="post")
 * @ORM\Entity(repositoryClass="EspritApiBundle\Repository\PostRepository")
 */
class Post
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="EspritApiBundle\Entity\Commentaire", mappedBy="post",cascade={"remove"}, orphanRemoval=true)
     */
    private $comments;
